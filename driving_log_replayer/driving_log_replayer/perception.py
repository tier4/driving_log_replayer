...
from driving_log_replayer.perception_eval_conversions import extract_pass_fail_objects_description
...
class Perception(EvaluationItem):
    ...
    def set_frame(
        ...
        return {
            ...
            "Objects": extract_pass_fail_objects_description(ret_frame.pass_fail_result),
        }
